"""
Example 04: 1D wave packet scattering off a periodic structure of multiple barriers.
Demonstrates band-like reflection/transmission and wave packet splitting.
"""
import os
import numpy as np
...
def main():
    ...
    # Wave packet parameters moving to the right
    x0 = -20.0
    sigma = 3.0
    k0 = 4.0

    # Multiple barriers parameters
    V0 = 8.0
    width = 0.8
    ...
    # Calculate reflection and transmission relative to the right edge of the barrier array
    ...
    plot_wavefunction_1d(
        wf_current,
        potential=potential,
        title="Multiple Barrier Scattering (Final State)",
        save_path="output/04_multiple_barriers_final.png",
        show=False,
        theme="light"
    )

    # 2. 3D space-time plot
    ...
    plot_space_time_3d(
        ...
        space_time,
        x_range=(-30, 30),
        title="Multiple Barrier Space-Time Evolution (3D)",
        save_path="output/04_multiple_barriers_spacetime.png",
        show=False,
        theme="light"
    )
    ...
    plot_dual_space_1d(
        wf_current,
        title="Multiple Barrier Scattering: Position vs Momentum Space",
        save_path="output/04_multiple_barriers_dual.png",
        show=False,
        theme="light"
    )
