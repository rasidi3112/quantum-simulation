"""
Random disorder potentials for simulating phenomena like Anderson localization.
"""
import numpy as np
...
class RandomDisorder(Potential):
    ...
    Divides the space into cells of 'cell_width' and assigns a uniform random potential in [-W/2, W/2] to each cell.
    """
    ...
    def evaluate(self, grid) -> np.ndarray:
        ...
        if isinstance(grid, Grid2D):
            # Evaluate along x and expand/broadcast to 2D
