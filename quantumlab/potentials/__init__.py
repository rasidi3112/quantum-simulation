...
from quantumlab.potentials.barriers import (
    GaussianBarrier, RectangularBarrier, PotentialStep, MultipleBarriers, ResonantTunnelingDiode
)
from quantumlab.potentials.wells import (
...
def create_potential(name: str, **kwargs) -> Potential:
    """
    Factory function to create a potential from its registry name.
    """
